...
public WebDriver driver;
	...
	public void InputBox(){
		...
		driver.findElement(By.name("password")).sendKeys("zhao123");
...
//		}
		 ...
		 * 输入报价反馈名称
		 * */
		driver.findElement(By.name("offerFeedbackName")).sendKeys("Feedback02");
		 ...
		 * 联系人姓名
		 * */
		driver.findElement(By.name("offerName")).sendKeys("华北报价员");
		this.sleep(1000);
		 ...
		 * 邮箱
		 * */
		driver.findElement(By.name("offerEmail")).sendKeys("hbbjy@163.com");
		this.sleep(1000);
	...
	public static void main(String[] args) {
		//实例化对象
		Quotation_2 action = new Quotation_2();
		action.InitDriver();
		action.InputBox();
