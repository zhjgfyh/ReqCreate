...
public class RequestJC {
	...
	public void purchaseRequest(){
		 ...
		 * 输入采购申请编号 
		 * */
		driver.findElement(By.className("whiteMsgIpt")).sendKeys("JC-3000");
		this.sleep(1000);
		...
		driver.findElement(By.name("receiveAddress")).sendKeys("BJ-110-101");
		this.sleep(1000);
		...
		// 输入联系人姓名
		driver.findElement(By.name("linkmanName")).sendKeys("北京哥哥");
		this.sleep(1000);
		...
		// 输入备注
		driver.findElement(By.name("remark")).sendKeys("测试采购申请创建");
		this.sleep(1000);
