...
public WebDriver driver;
	...
	public void quoataionFeedback(){
		 ...
		 * 输入报价反馈名称
		 * */
		driver.findElement(By.name("offerFeedbackName")).sendKeys("Feedback01");
		 ...
		 * 联系人姓名
		 * */
		driver.findElement(By.name("offerName")).sendKeys("华东报价员");
		this.sleep(1000);
		 ...
		 * 邮箱
		 * */
		driver.findElement(By.name("offerEmail")).sendKeys("hdbjy@163.com");
		this.sleep(1000);
	...
	public static void main(String[] args) {
		//实例化对象
		Quotation action = new Quotation();
		action.InitDriver();
		action.InputBox();
